...
<img style="width: 600px; height: 262px;" src="https://assets.leetcode.com/uploads/2022/01/15/logic1.jpg" alt="">
...
<img style="width: 600px; height: 262px;" src="https://assets.leetcode.com/uploads/2022/01/15/logic2.jpg" alt="">
...
由题意得最多有<code>n = 15</code>个人，所以枚举所有的情况复杂度为O(n^2 * 2^n).
使用二进制表示枚举的情况，并判断枚举情况是否矛盾，如果不矛盾则输出答案。
